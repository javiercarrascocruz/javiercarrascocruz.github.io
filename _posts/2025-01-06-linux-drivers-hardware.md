...
summary:    Datasheets, Linux subsystems and initial setup
permalink:  /:title
image:      /images/posts/2025-01-06-ldd1-hw/ldd1-hw.webp
tags:       drivers hardware linux
---

This article is still only available on Patreon for **Early Byte Bikers** [here](https://www.patreon.com/posts/linux-drivers-1-119443211?utm_medium=clipboard_copy&utm_source=copyLink&utm_campaign=postshare_creator&utm_content=join_link). If you would like to support my work and get early access to my articles, you can do so on my Patreon profile and start reading this article right now.
