...
permalink:  /:title
image:      /images/posts/2024-04-09-smatch/blue-bug.webp
...
<figure>
    <img src="/images/posts/2024-04-09-smatch/uninitialized-vars.webp"
...
Oddly enough, I did not know that Dan would join us for a mentoring session at the **LKMP** to talk about *smatch*, and that session took place a few minutes before I published this article :grin: If you would like to attend such mentoring sessions and learn from the most experienced kernel developers, click on [this link](/lkmp) and learn how to join the Linux Kernel Mentoring Program.
