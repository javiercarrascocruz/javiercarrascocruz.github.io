...
<iframe src="https://ridewithgps.com/embeds?type=route&id=53529058&metricUnits=true&sampleGraph=true&privacyCode=jTl5BskGONbi8Fd2suBcbwlxZpYcMMM2" style="width: 1px; min-width: 100%; height: 700px; border: none;" scrolling="no"></iframe>
...
- <a href="{{ '/bikepacking/gpx/mongolia-bulgan-olgii/taikeshken-bulgan.gpx' | relative_url }}" download>Day 0: Taikeshken - Bulgan</a>
- <a href="{{ '/bikepacking/gpx/mongolia-bulgan-olgii/bulgan-olgii-1.gpx' | relative_url }}" download>Bulgan - Ölgii (day 1)</a>
- <a href="{{ '/bikepacking/gpx/mongolia-bulgan-olgii/bulgan-olgii-2.gpx' | relative_url }}" download>Bulgan - Ölgii (day 2)</a>
- <a href="{{ '/bikepacking/gpx/mongolia-bulgan-olgii/bulgan-olgii-3.gpx' | relative_url }}" download>Bulgan - Ölgii (day 3)</a>
- <a href="{{ '/bikepacking/gpx/mongolia-bulgan-olgii/bulgan-olgii-4.gpx' | relative_url }}" download>Bulgan - Ölgii (day 4)</a>
- <a href="{{ '/bikepacking/gpx/mongolia-bulgan-olgii/bulgan-olgii-5.gpx' | relative_url }}" download>Bulgan - Ölgii (day 5)</a>
- <a href="{{ '/bikepacking/gpx/mongolia-bulgan-olgii/bulgan-olgii-6.gpx' | relative_url }}" download>Bulgan - Ölgii (day 6)</a>
